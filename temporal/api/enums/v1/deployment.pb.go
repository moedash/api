...
const (
	...
	DeploymentReachability_DEPLOYMENT_REACHABILITY_UNSPECIFIED DeploymentReachability = 0
	// The deployment is reachable by new and/or open workflows. The deployment cannot be
	// decommissioned safely.
	DeploymentReachability_DEPLOYMENT_REACHABILITY_REACHABLE DeploymentReachability = 1
	...
	DeploymentReachability_DEPLOYMENT_REACHABILITY_CLOSED_WORKFLOWS_ONLY DeploymentReachability = 2
	...
	DeploymentReachability_DEPLOYMENT_REACHABILITY_UNREACHABLE DeploymentReachability = 3
)
...
const (
	...
	VersionDrainageStatus_VERSION_DRAINAGE_STATUS_UNSPECIFIED VersionDrainageStatus = 0
	...
	VersionDrainageStatus_VERSION_DRAINAGE_STATUS_DRAINING VersionDrainageStatus = 1
	...
	VersionDrainageStatus_VERSION_DRAINAGE_STATUS_DRAINED VersionDrainageStatus = 2
)
...
const (
	WorkerVersioningMode_WORKER_VERSIONING_MODE_UNSPECIFIED WorkerVersioningMode = 0
	...
	WorkerVersioningMode_WORKER_VERSIONING_MODE_UNVERSIONED WorkerVersioningMode = 1
	...
	WorkerVersioningMode_WORKER_VERSIONING_MODE_VERSIONED WorkerVersioningMode = 2
)
...
const (
	WorkerDeploymentVersionStatus_WORKER_DEPLOYMENT_VERSION_STATUS_UNSPECIFIED WorkerDeploymentVersionStatus = 0
	...
	WorkerDeploymentVersionStatus_WORKER_DEPLOYMENT_VERSION_STATUS_INACTIVE WorkerDeploymentVersionStatus = 1
	...
	WorkerDeploymentVersionStatus_WORKER_DEPLOYMENT_VERSION_STATUS_CURRENT WorkerDeploymentVersionStatus = 2
	...
	WorkerDeploymentVersionStatus_WORKER_DEPLOYMENT_VERSION_STATUS_RAMPING WorkerDeploymentVersionStatus = 3
	// The Worker Deployment Version is not used by new workflows but is still used by
	// open pinned workflows. The version cannot be decommissioned safely.
	WorkerDeploymentVersionStatus_WORKER_DEPLOYMENT_VERSION_STATUS_DRAINING WorkerDeploymentVersionStatus = 4
	// The Worker Deployment Version is not used by new or open workflows, but might be still needed by
	// Queries sent to closed workflows. The version can be decommissioned safely if user does
	// not query closed workflows. If the user does query closed workflows for some time x after
	// workflows are closed, they should decommission the version after it has been drained for that duration.
...
var file_temporal_api_enums_v1_deployment_proto_rawDesc = []byte{
	...
	0x44, 0x10, 0x02, 0x2a, 0xe7, 0x02, 0x0a, 0x1d, 0x57, 0x6f, 0x72, 0x6b, 0x65, 0x72, 0x44, 0x65,
	...
	0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x44, 0x52, 0x41, 0x49, 0x4e, 0x45, 0x44, 0x10, 0x05, 0x12,
	0x2c, 0x0a, 0x28, 0x57, 0x4f, 0x52, 0x4b, 0x45, 0x52, 0x5f, 0x44, 0x45, 0x50, 0x4c, 0x4f, 0x59,
	0x4d, 0x45, 0x4e, 0x54, 0x5f, 0x56, 0x45, 0x52, 0x53, 0x49, 0x4f, 0x4e, 0x5f, 0x53, 0x54, 0x41,
	0x54, 0x55, 0x53, 0x5f, 0x43, 0x52, 0x45, 0x41, 0x54, 0x45, 0x44, 0x10, 0x06, 0x42, 0x87, 0x01,
	0x0a, 0x18, 0x69, 0x6f, 0x2e, 0x74, 0x65, 0x6d, 0x70, 0x6f, 0x72, 0x61, 0x6c, 0x2e, 0x61, 0x70,
	0x69, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x76, 0x31, 0x42, 0x0f, 0x44, 0x65, 0x70, 0x6c,
	0x6f, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x21, 0x67,
