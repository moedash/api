...
const (
	WorkflowIdConflictPolicy_WORKFLOW_ID_CONFLICT_POLICY_UNSPECIFIED WorkflowIdConflictPolicy = 0
	// Don't start a new workflow; instead return `WorkflowExecutionAlreadyStartedFailure`.
	WorkflowIdConflictPolicy_WORKFLOW_ID_CONFLICT_POLICY_FAIL WorkflowIdConflictPolicy = 1
	// Don't start a new workflow; instead return a workflow handle for the running workflow.
	WorkflowIdConflictPolicy_WORKFLOW_ID_CONFLICT_POLICY_USE_EXISTING WorkflowIdConflictPolicy = 2
	// Terminate the running workflow before starting a new one.
	WorkflowIdConflictPolicy_WORKFLOW_ID_CONFLICT_POLICY_TERMINATE_EXISTING WorkflowIdConflictPolicy = 3
)
...
const (
	...
	WorkflowExecutionStatus_WORKFLOW_EXECUTION_STATUS_PAUSED           WorkflowExecutionStatus = 8
)
...
const (
	...
	PendingActivityState_PENDING_ACTIVITY_STATE_PAUSED PendingActivityState = 4
	// PAUSE_REQUESTED means activity is currently running on the worker, but paused on the server
	PendingActivityState_PENDING_ACTIVITY_STATE_PAUSE_REQUESTED PendingActivityState = 5
)
...
const (
	...
	VersioningBehavior_VERSIONING_BEHAVIOR_UNSPECIFIED VersioningBehavior = 0
	...
	// task queue.
	VersioningBehavior_VERSIONING_BEHAVIOR_PINNED VersioningBehavior = 1
	...
	VersioningBehavior_VERSIONING_BEHAVIOR_AUTO_UPGRADE VersioningBehavior = 2
)
...
const (
	ContinueAsNewVersioningBehavior_CONTINUE_AS_NEW_VERSIONING_BEHAVIOR_UNSPECIFIED ContinueAsNewVersioningBehavior = 0
	// Experimental.
	...
	ContinueAsNewVersioningBehavior_CONTINUE_AS_NEW_VERSIONING_BEHAVIOR_AUTO_UPGRADE ContinueAsNewVersioningBehavior = 1
	// Experimental.
	...
	// new workflow run regardless of the ContinueAsNewVersioningBehavior specified in the continue-as-new
	// command. Versioning Override always takes precedence until it's removed manually via UpdateWorkflowExecutionOptions.
	ContinueAsNewVersioningBehavior_CONTINUE_AS_NEW_VERSIONING_BEHAVIOR_USE_RAMPING_VERSION ContinueAsNewVersioningBehavior = 2
)
...
const (
	SuggestContinueAsNewReason_SUGGEST_CONTINUE_AS_NEW_REASON_UNSPECIFIED SuggestContinueAsNewReason = 0
	// Workflow History size is getting too large.
	SuggestContinueAsNewReason_SUGGEST_CONTINUE_AS_NEW_REASON_HISTORY_SIZE_TOO_LARGE SuggestContinueAsNewReason = 1
	// Workflow History event count is getting too large.
	SuggestContinueAsNewReason_SUGGEST_CONTINUE_AS_NEW_REASON_TOO_MANY_HISTORY_EVENTS SuggestContinueAsNewReason = 2
	// Workflow's count of completed plus in-flight updates is too large.
	SuggestContinueAsNewReason_SUGGEST_CONTINUE_AS_NEW_REASON_TOO_MANY_UPDATES SuggestContinueAsNewReason = 3
)
...
var file_temporal_api_enums_v1_workflow_proto_rawDesc = []byte{
	...
	0x2e, 0x61, 0x70, 0x69, 0x2e, 0x65, 0x6e, 0x75, 0x6d, 0x73, 0x2e, 0x76, 0x31, 0x2a, 0x8f, 0x02,
	...
	0x4c, 0x49, 0x43, 0x41, 0x54, 0x45, 0x10, 0x03, 0x12, 0x35, 0x0a, 0x2d, 0x57, 0x4f, 0x52, 0x4b,
	...
	0x46, 0x5f, 0x52, 0x55, 0x4e, 0x4e, 0x49, 0x4e, 0x47, 0x10, 0x04, 0x1a, 0x02, 0x08, 0x01, 0x2a,
	0xcf, 0x01, 0x0a, 0x18, 0x57, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x49, 0x64, 0x43, 0x6f,
	0x6e, 0x66, 0x6c, 0x69, 0x63, 0x74, 0x50, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x12, 0x2b, 0x0a, 0x27,
	0x57, 0x4f, 0x52, 0x4b, 0x46, 0x4c, 0x4f, 0x57, 0x5f, 0x49, 0x44, 0x5f, 0x43, 0x4f, 0x4e, 0x46,
	0x4c, 0x49, 0x43, 0x54, 0x5f, 0x50, 0x4f, 0x4c, 0x49, 0x43, 0x59, 0x5f, 0x55, 0x4e, 0x53, 0x50,
	...
	,
	...
	0x43, 0x41, 0x4e, 0x43, 0x45, 0x4c, 0x10, 0x03, 0x2a, 0xbd, 0x01, 0x0a, 0x16, 0x43, 0x6f, 0x6e,
	0x74, 0x69, 0x6e, 0x75, 0x65, 0x41, 0x73, 0x4e, 0x65, 0x77, 0x49, 0x6e, 0x69, 0x74, 0x69, 0x61,
	0x74, 0x6f, 0x72, 0x12, 0x29, 0x0a, 0x25, 0x43, 0x4f, 0x4e, 0x54, 0x49, 0x4e, 0x55, 0x45, 0x5f,
	...
	,
	...
	0x55, 0x53, 0x45, 0x44, 0x10, 0x08, 0x2a, 0x84, 0x02, 0x0a, 0x14, 0x50, 0x65, 0x6e, 0x64, 0x69,
	0x6e, 0x67, 0x41, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12,
	0x26, 0x0a, 0x22, 0x50, 0x45, 0x4e, 0x44, 0x49, 0x4e, 0x47, 0x5f, 0x41, 0x43, 0x54, 0x49, 0x56,
	0x49, 0x54, 0x59, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x45, 0x5f, 0x55, 0x4e, 0x53, 0x50, 0x45, 0x43,
	0x49, 0x46, 0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x24, 0x0a, 0x20, 0x50, 0x45, 0x4e, 0x44, 0x49,
	...
	,
	...
	0x49, 0x46, 0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x29, 0x0a, 0x25, 0x50, 0x45, 0x4e, 0x44, 0x49,
	...
	,
