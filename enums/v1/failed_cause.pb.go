...
const (
	...
	WorkflowTaskFailedCause_WORKFLOW_TASK_FAILED_CAUSE_BAD_SCHEDULE_NEXUS_OPERATION_ATTRIBUTES WorkflowTaskFailedCause = 32
	// A workflow task completed requesting to schedule a Nexus Operation exceeding the server configured limit.
	WorkflowTaskFailedCause_WORKFLOW_TASK_FAILED_CAUSE_PENDING_NEXUS_OPERATIONS_LIMIT_EXCEEDED WorkflowTaskFailedCause = 33
	// A workflow task completed with an invalid RequestCancelNexusOperation command.
	WorkflowTaskFailedCause_WORKFLOW_TASK_FAILED_CAUSE_BAD_REQUEST_CANCEL_NEXUS_OPERATION_ATTRIBUTES WorkflowTaskFailedCause = 34
	...
	WorkflowTaskFailedCause_WORKFLOW_TASK_FAILED_CAUSE_FEATURE_DISABLED WorkflowTaskFailedCause = 35
	// A workflow task failed because a grpc message was too large.
	WorkflowTaskFailedCause_WORKFLOW_TASK_FAILED_CAUSE_GRPC_MESSAGE_TOO_LARGE WorkflowTaskFailedCause = 36
	// A workflow task failed because payloads were too large.
	WorkflowTaskFailedCause_WORKFLOW_TASK_FAILED_CAUSE_PAYLOADS_TOO_LARGE WorkflowTaskFailedCause = 37
	// A workflow task failed because an external storage operation failed.
	// Check the workflow task failure message for more information.
	WorkflowTaskFailedCause_WORKFLOW_TASK_FAILED_CAUSE_EXTERNAL_STORAGE_FAILURE WorkflowTaskFailedCause = 38
	// A workflow task is failed because the workflow is paused before the task is started.
	WorkflowTaskFailedCause_WORKFLOW_TASK_FAILED_CAUSE_WORKFLOW_PAUSE_REQUESTED_BEFORE_TASK_STARTED WorkflowTaskFailedCause = 39
	// A workflow task failed because the request exceeded a size limit.
	WorkflowTaskFailedCause_WORKFLOW_TASK_FAILED_CAUSE_REQUEST_TOO_LARGE WorkflowTaskFailedCause = 40
)
...
const (
	...
	StartChildWorkflowExecutionFailedCause_START_CHILD_WORKFLOW_EXECUTION_FAILED_CAUSE_INVALID_VERSIONING_OVERRIDE StartChildWorkflowExecutionFailedCause = 3
)
...
const (
	...
	ResourceExhaustedCause_RESOURCE_EXHAUSTED_CAUSE_PERSISTENCE_STORAGE_LIMIT ResourceExhaustedCause = 7
	// Circuit breaker is open/half-open.
	ResourceExhaustedCause_RESOURCE_EXHAUSTED_CAUSE_CIRCUIT_BREAKER_OPEN ResourceExhaustedCause = 8
	// Namespace exceeds operations rate limit.
	ResourceExhaustedCause_RESOURCE_EXHAUSTED_CAUSE_OPS_LIMIT ResourceExhaustedCause = 9
	// Limits related to Worker Deployments are reached.
	ResourceExhaustedCause_RESOURCE_EXHAUSTED_CAUSE_WORKER_DEPLOYMENT_LIMITS ResourceExhaustedCause = 10
)
...
const (
	ResourceExhaustedScope_RESOURCE_EXHAUSTED_SCOPE_UNSPECIFIED ResourceExhaustedScope = 0
	// Exhausted resource is a namespace-level resource.
	ResourceExhaustedScope_RESOURCE_EXHAUSTED_SCOPE_NAMESPACE ResourceExhaustedScope = 1
	// Exhausted resource is a system-level resource.
	ResourceExhaustedScope_RESOURCE_EXHAUSTED_SCOPE_SYSTEM ResourceExhaustedScope = 2
)
...
var file_temporal_api_enums_v1_failed_cause_proto_rawDesc = []byte{
	...
	0x31, 0x2a, 0x90, 0x14, 0x0a, 0x17, 0x57, 0x6f, 0x72, 0x6b, 0x66, 0x6c, 0x6f, 0x77, 0x54, 0x61,
	...
	,
	...
	0x53, 0x54, 0x53, 0x10, 0x01, 0x12, 0x43, 0x0a, 0x3f, 0x53, 0x54, 0x41, 0x52, 0x54, 0x5f, 0x43,
	...
	0x41, 0x55, 0x53, 0x45, 0x5f, 0x4e, 0x41, 0x4d, 0x45, 0x53, 0x50, 0x41, 0x43, 0x45, 0x5f, 0x4e,
	0x4f, 0x54, 0x5f, 0x46, 0x4f, 0x55, 0x4e, 0x44, 0x10, 0x02, 0x12, 0x4b, 0x0a, 0x47, 0x53, 0x54,
	...
	0x44, 0x5f, 0x56, 0x45, 0x52, 0x53, 0x49, 0x4f, 0x4e, 0x49, 0x4e, 0x47, 0x5f, 0x4f, 0x56, 0x45,
	0x52, 0x52, 0x49, 0x44, 0x45, 0x10, 0x03, 0x2a, 0x91, 0x02, 0x0a, 0x2a, 0x43, 0x61, 0x6e, 0x63,
	...
	0x64, 0x43, 0x61, 0x75, 0x73, 0x65, 0x12, 0x3f, 0x0a, 0x3b, 0x43, 0x41, 0x4e, 0x43, 0x45, 0x4c,
	0x5f, 0x45, 0x58, 0x54, 0x45, 0x52, 0x4e, 0x41, 0x4c, 0x5f, 0x57, 0x4f, 0x52, 0x4b, 0x46, 0x4c,
	0x4f, 0x57, 0x5f, 0x45, 0x58, 0x45, 0x43, 0x55, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x46, 0x41, 0x49,
	0x4c, 0x45, 0x44, 0x5f, 0x43, 0x41, 0x55, 0x53, 0x45, 0x5f, 0x55, 0x4e, 0x53, 0x50, 0x45, 0x43,
	0x49, 0x46, 0x49, 0x45, 0x44, 0x10, 0x00, 0x12, 0x59, 0x0a, 0x55, 0x43, 0x41, 0x4e, 0x43, 0x45,
	...
	0x43, 0x55, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x4e, 0x4f, 0x54, 0x5f, 0x46, 0x4f, 0x55, 0x4e, 0x44,
	0x10, 0x01, 0x12, 0x47, 0x0a, 0x43, 0x43, 0x41, 0x4e, 0x43, 0x45, 0x4c, 0x5f, 0x45, 0x58, 0x54,
	...
	0x43, 0x41, 0x55, 0x53, 0x45, 0x5f, 0x4e, 0x41, 0x4d, 0x45, 0x53, 0x50, 0x41, 0x43, 0x45, 0x5f,
	0x4e, 0x4f, 0x54, 0x5f, 0x46, 0x4f, 0x55, 0x4e, 0x44, 0x10, 0x02, 0x2a, 0xe2, 0x02, 0x0a, 0x2a,
	...
	0x61, 0x69, 0x6c, 0x65, 0x64, 0x43, 0x61, 0x75, 0x73, 0x65, 0x12, 0x3f, 0x0a, 0x3b, 0x53, 0x49,
	...
	,
	...
	0x53, 0x45, 0x5f, 0x53, 0x49, 0x47, 0x4e, 0x41, 0x4c, 0x5f, 0x43, 0x4f, 0x55, 0x4e, 0x54, 0x5f,
	0x4c, 0x49, 0x4d, 0x49, 0x54, 0x5f, 0x45, 0x58, 0x43, 0x45, 0x45, 0x44, 0x45, 0x44, 0x10, 0x03,
	0x2a, 0x97, 0x04, 0x0a, 0x16, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x45, 0x78, 0x68,
	0x61, 0x75, 0x73, 0x74, 0x65, 0x64, 0x43, 0x61, 0x75, 0x73, 0x65, 0x12, 0x28, 0x0a, 0x24, 0x52,
	...
	,
