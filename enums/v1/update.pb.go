...
const (
	UpdateAdmittedEventOrigin_UPDATE_ADMITTED_EVENT_ORIGIN_UNSPECIFIED UpdateAdmittedEventOrigin = 0
	...
	UpdateAdmittedEventOrigin_UPDATE_ADMITTED_EVENT_ORIGIN_REAPPLY UpdateAdmittedEventOrigin = 1
)
