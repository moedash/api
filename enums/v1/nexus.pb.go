...
const (
	NexusHandlerErrorRetryBehavior_NEXUS_HANDLER_ERROR_RETRY_BEHAVIOR_UNSPECIFIED NexusHandlerErrorRetryBehavior = 0
	// A handler error is explicitly marked as retryable.
	NexusHandlerErrorRetryBehavior_NEXUS_HANDLER_ERROR_RETRY_BEHAVIOR_RETRYABLE NexusHandlerErrorRetryBehavior = 1
	// A handler error is explicitly marked as non-retryable.
	NexusHandlerErrorRetryBehavior_NEXUS_HANDLER_ERROR_RETRY_BEHAVIOR_NON_RETRYABLE NexusHandlerErrorRetryBehavior = 2
)
...
const (
	NexusOperationExecutionStatus_NEXUS_OPERATION_EXECUTION_STATUS_UNSPECIFIED NexusOperationExecutionStatus = 0
	...
	NexusOperationExecutionStatus_NEXUS_OPERATION_EXECUTION_STATUS_RUNNING NexusOperationExecutionStatus = 1
	// The operation completed successfully.
	NexusOperationExecutionStatus_NEXUS_OPERATION_EXECUTION_STATUS_COMPLETED NexusOperationExecutionStatus = 2
	// The operation completed with failure.
	NexusOperationExecutionStatus_NEXUS_OPERATION_EXECUTION_STATUS_FAILED NexusOperationExecutionStatus = 3
	...
	NexusOperationExecutionStatus_NEXUS_OPERATION_EXECUTION_STATUS_CANCELED NexusOperationExecutionStatus = 4
	// The operation was terminated. Termination happens immediately without notifying the handler.
	NexusOperationExecutionStatus_NEXUS_OPERATION_EXECUTION_STATUS_TERMINATED NexusOperationExecutionStatus = 5
	// The operation has timed out by reaching one of the specified timeouts.
	NexusOperationExecutionStatus_NEXUS_OPERATION_EXECUTION_STATUS_TIMED_OUT NexusOperationExecutionStatus = 6
)
...
const (
	NexusOperationWaitStage_NEXUS_OPERATION_WAIT_STAGE_UNSPECIFIED NexusOperationWaitStage = 0
	// Wait for the operation to be started.
	NexusOperationWaitStage_NEXUS_OPERATION_WAIT_STAGE_STARTED NexusOperationWaitStage = 1
	// Wait for the operation to be in a terminal state, either successful or unsuccessful.
	NexusOperationWaitStage_NEXUS_OPERATION_WAIT_STAGE_CLOSED NexusOperationWaitStage = 2
)
...
const (
	NexusOperationIdReusePolicy_NEXUS_OPERATION_ID_REUSE_POLICY_UNSPECIFIED NexusOperationIdReusePolicy = 0
	// Always allow starting an operation using the same operation ID.
	NexusOperationIdReusePolicy_NEXUS_OPERATION_ID_REUSE_POLICY_ALLOW_DUPLICATE NexusOperationIdReusePolicy = 1
	...
	NexusOperationIdReusePolicy_NEXUS_OPERATION_ID_REUSE_POLICY_ALLOW_DUPLICATE_FAILED_ONLY NexusOperationIdReusePolicy = 2
	...
	NexusOperationIdReusePolicy_NEXUS_OPERATION_ID_REUSE_POLICY_REJECT_DUPLICATE NexusOperationIdReusePolicy = 3
)
...
const (
	NexusOperationIdConflictPolicy_NEXUS_OPERATION_ID_CONFLICT_POLICY_UNSPECIFIED NexusOperationIdConflictPolicy = 0
	// Don't start a new operation; instead return `NexusOperationAlreadyStarted` error.
	NexusOperationIdConflictPolicy_NEXUS_OPERATION_ID_CONFLICT_POLICY_FAIL NexusOperationIdConflictPolicy = 1
	// Don't start a new operation; instead return a handle for the running operation.
	NexusOperationIdConflictPolicy_NEXUS_OPERATION_ID_CONFLICT_POLICY_USE_EXISTING NexusOperationIdConflictPolicy = 2
)
